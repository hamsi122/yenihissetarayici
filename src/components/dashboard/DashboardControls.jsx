import { Activity, RefreshCw, Search, RotateCcw, Loader2 } from "lucide-react";
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div data-testid="dashboard-header-info">
            ...
            <p className="mt-1 text-sm text-muted-foreground" data-testid="dashboard-main-subtitle">
              Nasdaq ve BIST hisselerini taramak için geliştirilmiş formasyon kırılımı ve açıklanabilir AI raporu sunan profesyonel analiz terminali.
            </p>
          </div>
        ...
        <div className="grid gap-3 lg:grid-cols-12" data-testid="dashboard-filter-grid">
          ...
          <div className="lg:col-span-3" data-testid="symbol-search-section">
            ...
            {(analyzing || analyzeProgress > 0) && (
              <div className="mt-2 space-y-1" data-testid="symbol-analyze-progress">
                <Progress value={analyzeProgress} className="h-1.5" data-testid="symbol-analyze-progress-bar" />
                <p className="text-[11px] font-mono text-muted-foreground" data-testid="symbol-analyze-progress-label">
                  {analyzeProgress >= 100
                    ? "Analiz tamamlandı %100"
                    : `Analiz yapılıyor... %${analyzeProgress}`}
                </p>
              </div>
            )}
          </div>
